...
- `postgres_password: "<REDACTED>"` (plaintext)
- `internal_db_url: "postgres://user:<REDACTED>@internal-host:5432/db"` (plaintext creds)
- `external_db_url: "postgres://user:<REDACTED>@external-host:3522/db"` (plaintext creds)
