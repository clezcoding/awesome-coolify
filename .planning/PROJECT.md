...
- [ ] MCP-Server in TypeScript mit `@modelcontextprotocol/sdk`
- [ ] Action-basiertes Tool-Schema ab v1 (Domänen + `action`, keine 60+ Einzeltools)
- [ ] Multi-Instance via `~/.coolify-mcp/instances.json` (add, list, get, update, delete, set-default, switch, verify)
- [ ] Ops-Tools v1: Infrastructure-Overview, Diagnose (App/Server), Deploy (inkl. wait-poll), Logs (limitiert/follow), Global Issue-Scan
- [ ] Structured Error Codes mit Recovery-Hints (401/404/422/500 etc.)
