# Requirements Archive: v1.0 Ops MVP
...
- [x] **CTX-01**: Agent kann Coolify-API-Verbindung per Health-Check verifizieren — **validated v1.0**
- [x] **CTX-02**: Agent kann Coolify-Instanz-Version abfragen — **validated v1.0**
- [x] **CTX-03**: Agent kann MCP-Server-Version (Meta) abfragen — **validated v1.0**
- [ ] **CTX-04**: Agent kann mehrere Instanzen in `~/.coolify-mcp/instances.json` verwalten — **deferred v2**
- [ ] **CTX-05**: Agent kann Default-Instanz setzen und zwischen Instanzen wechseln — **deferred v2**
- [ ] **CTX-06**: Agent kann pro Request API-Token override nutzen — **deferred v2**
- [x] **CTX-07**: Agent kann Instanz-Verbindung verifizieren (verify) inkl. Version — **validated v1.0** (single env-backed instance)
...
- [ ] **SVC-04**: Agent kann Service/Database Logs lesen (limitiert) — **deferred v1.1** (no Coolify 4.1.x endpoint)
...
- [x] **ERR-01**: API-Fehler liefern structured error codes (401, 404, 422, 500) — **validated v1.0**
- [x] **ERR-02**: Jeder Fehler enthält Recovery-Hints für den Agent — **validated v1.0**
- [x] **ERR-03**: Transiente API-Fehler werden mit Retry + Exponential Backoff behandelt — **validated v1.0**

### Tool Schema & DX (DX)

- [x] **DX-01**: Tools sind action-basiert pro Domäne — **validated v1.0**
- [x] **DX-02**: Zod-Schemas validieren alle Tool-Inputs — **validated v1.0**
...
|-------------|-------|--------|
| CTX-01 | 1 — Foundation & Multi-Instance Auth | Complete |
| CTX-02 | 1 — Foundation & Multi-Instance Auth | Complete |
| CTX-03 | 1 — Foundation & Multi-Instance Auth | Complete |
| CTX-04 | 1 — Foundation & Multi-Instance Auth | Deferred v2 |
| CTX-05 | 1 — Foundation & Multi-Instance Auth | Deferred v2 |
| CTX-06 | 1 — Foundation & Multi-Instance Auth | Deferred v2 |
| CTX-07 | 1 — Foundation & Multi-Instance Auth | Complete |
| ERR-01 | 1 — Foundation & Multi-Instance Auth | Complete |
| ERR-02 | 1 — Foundation & Multi-Instance Auth | Complete |
| ERR-03 | 1 — Foundation & Multi-Instance Auth | Complete |
| DX-01 | 1 — Foundation & Multi-Instance Auth | Complete |
| DX-02 | 1 — Foundation & Multi-Instance Auth | Complete |
...
| APP-03 | 4 — App Deploy Lifecycle | Complete |
...
| SVC-04 | 5 — Logs & Service/DB Ops | Deferred v1.1 |
