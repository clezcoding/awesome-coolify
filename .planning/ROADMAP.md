...
- [x] 27-00-PLAN.md — Wave 0 RED scaffolds (BRND-01 + DOC-01 tests)
- [x] 27-01-PLAN.md — Tracer: dual icons build pipeline + D-08 version parity
...
- [x] 27-03-PLAN.md — DOC-01 public docs parity (PROJECT, README EN/DE)
