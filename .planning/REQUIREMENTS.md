...
- [ ] **SYS-01**: Agent kann Infrastructure-Overview abrufen (Counts: servers, projects, apps, databases, services)
- [ ] **SYS-02**: Agent kann alle Resources unified listen (apps + DBs + services)
...
- [ ] **SYS-06**: Agent kann Resource per UUID, Name, Domain oder IP finden (Discovery)
- [ ] **SYS-07**: Agent kann Coolify-Dokumentation durchsuchen (How-to, Config, Troubleshooting)

### Application Operations (APP)

- [ ] **APP-01**: Agent kann Apps listen (summary projection, essential fields)
- [ ] **APP-02**: Agent kann App-Details abrufen (get, summary oder full projection)
...
- [ ] **SVC-01**: Agent kann Services und Databases listen (summary projection)
- [ ] **SVC-02**: Agent kann Service/Database Details abrufen
...
- [ ] **OUT-01**: Agent kann Response-Formate wählen (table, JSON, pretty)
- [ ] **OUT-02**: Sensitive-Werte sind default maskiert (`***`), reveal opt-in
- [ ] **OUT-03**: Pagination unterstützt (page, per_page)
- [ ] **OUT-04**: Summary vs. Full-Detail Projektionen verfügbar
- [ ] **OUT-05**: `max_chars` Cap verhindert Context-Bloat bei großen Payloads
...
- [ ] **DX-03**: Automatische Payload-Größen-Warnung vor großen Responses
...
- [ ] **DIST-03**: MCP stdio-Transport funktioniert in Cursor und Claude Desktop
